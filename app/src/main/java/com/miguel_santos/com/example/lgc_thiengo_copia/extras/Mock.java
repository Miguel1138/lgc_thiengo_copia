...
import com.miguel_santos.com.example.lgc_thiengo_copia.domain.User;

public class Mock {

    public static User criarUserAleatorio() {
        // Apagar drawables posteriormente
    ...
    public static Comercio criarComercioAleatorio() {
        ...
        String[] localizacoes = {"Centro Cultural São Paulo, Rua Vergueiro, 1000 - Paraíso, São Paulo - SP, 01504-000, Brasil",
