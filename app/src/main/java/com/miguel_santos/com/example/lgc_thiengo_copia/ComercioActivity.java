...
public class ComercioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new MaterialDialog.Builder(ComercioActivity.this)
                        ...
                        .positiveText("Ok").positiveColorRes(R.color.colorLink)
                        .show();
            }
        });
        ...
        ImageView ivCabecalho = findViewById(R.id.iv_cabecalho);
        ...
        TextView tvHorarioFuncionamento = findViewById(R.id.tv_horario_funcionamento);
